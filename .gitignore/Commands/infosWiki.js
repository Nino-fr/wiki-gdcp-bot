...
class Infos extends Command {
  ...
  async run(message) {
    const embed = new MessageEmbed()
      .setColor('BLUE')
      .setTitle('Informations sur le wiki ' + this.bot.wiki.name)
      .setDescription(
      ...
      .addField('Pages populaires', this.bot.wiki.popularPages)
      .addField(
        'Modifications totales actuelles',
        this.bot.wiki.totalChanges,
        true
      )
      .addField(
        'Fondateur',
      ...
      .addField('Pages au total', this.bot.wiki.totalPages, true)
      .addField("Nombre d'utilisateurs", this.bot.wiki.users, true)
      .addField("Nombre d'articles", this.bot.wiki.articles, true)
      .addField('Nombre de catégories', this.bot.wiki.categories.total, true);
